...
return array(
	...
	'seller'=>array(
		...
		'fields'=>array(
			...
			'desc'=>array('type'=>'textarea', 'str'=>'描述', 'hide'=>'list'),
			'shop_address'=>array('type'=>'textarea', 'str'=>'门市地址', 'hide'=>'list'),
			'depot_address'=>array('type'=>'textarea', 'str'=>'仓库地址'),
			'tel'=>array('type'=>'text', 'str'=>'门市电话', 'hide'=>'list'),
			'mobile'=>array('type'=>'text', 'str'=>'手机号码', 'hide'=>'list'),
			'fax'=>array('type'=>'text', 'str'=>'传真', 'hide'=>'list'),
