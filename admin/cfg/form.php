...
return array(
	'banner'=>array(
		...
		'fields'=>array(
			...
			'img'=>array('type'=>'file', 'str'=>'图片', 'hide'=>array('list')),
	...
	'seller'=>array(
		...
		'fields'=>array(
			...
			'depot_address'=>array('type'=>'textarea', 'str'=>'仓库地址', 'hide'=>array('list'), 'default'=>''),
	...
	'product'=>array(
		...
		'fields'=>array(
			...
			'danwei'=>array('type'=>'text', 'str'=>'单位', 'hide'=>array('list')),
			...
			'yongtu'=>array('type'=>'text', 'str'=>'用途', 'hide'=>array('list'), 'default'=>''),
			'huohao'=>array('type'=>'text', 'str'=>'货号', 'hide'=>array('list'), 'default'=>''),
			'img_model'=>array('type'=>'file', 'str'=>'模特效果图', 'hide'=>array('list')),
			'img_product'=>array('type'=>'file', 'str'=>'布料高清图', 'hide'=>array('list'), 'desc'=>'用于首页最热商品底图，非最热商品可不传', 'default'=>''),
			'desc'=>array('type'=>'editor', 'str'=>'详情', 'hide'=>array('list')),
